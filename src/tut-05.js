...
console.log(dimByTotalAndTip.top(Infinity).length);
console.log(dimByTotalAndTip.top(Infinity));

console.log('--- 4 --- dimByTotal.filter(90)');
const dimByTotal = cf.dimension(d => d.total);
dimByTotal.filter(90);
dimByTotalAndTip.filter(null);
console.log(cf.all().length);
console.log(cf.allFiltered([dimByTotalAndTip]).length);
console.log(dimByTotal.top(Infinity).length);
